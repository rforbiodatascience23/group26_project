...
::: {.column width="60%"}
![](../results/Comorbidities_risk.png){width=50% fig-align="left"}

:::

::: {.column width="40%"}

![](../results/income_medicalinsurance.png){width=100% fig-align="right"}
...
![](../results/model_estimates.png){width=100% fig-align="center"}
