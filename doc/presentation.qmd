...
```{r}
rhc_aug |> group_by(swang1, death) |> summarise(n = n())
```
...
![](../results/model_estimates.png){width=120% fig-align="center"}

![](../results/model_estimates_2.png){width=120% fig-align="center"}
