...
ggsave(filename = "model_estimates.png",
...
```{r}
#Plots the model estimate of the intercept
model_estimates_2 <- aps1_estimates |>
  ...
  labs(x='Estimates(95% CIs)', 
       y='Diseases',
       title = 'The estimate of the death outcome when the APACHE score is 0')

ggsave(filename = "model_estimates_2.png",
       plot = model_estimates_2,
       device = "png",
       path = "../results",
       scale = 1,
       limitsize = TRUE)
