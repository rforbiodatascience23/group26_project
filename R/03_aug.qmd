...
rhc_split1 <- rhc_aug1 |> select(-c(edu_group,comorbidities)) 
rhc_split2 <- rhc_aug1 |> select(c(ptID,edu_group,comorbidities))

rhc_aug1 <- inner_join(rhc_split1, rhc_split2, by ="ptID")
